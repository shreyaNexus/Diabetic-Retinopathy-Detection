...
#
# FIXES vs original:
#   - torch.meshgrid: added indexing='ij' to suppress deprecation warning in PyTorch ≥1.10
#     (missing indexing argument defaults to 'ij' now but will error in a future release)
# -----------------------------------------------------------------------------------
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        # FIX: added indexing='ij' — suppresses deprecation warning in PyTorch ≥1.10
...
class UpsampleOneStep(nn.Sequential):
    """UpsampleOneStep module — always 1conv + 1pixelshuffle."""
...
class SwinIR(nn.Module):
    ...
    Args: (unchanged from original — see paper for full list)
    """
...
if __name__ == '__main__':
    ...
    model = SwinIR(
        upscale=2, img_size=(height, width),
